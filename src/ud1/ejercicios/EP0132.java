...
public class EP0132 {
  public static void main(String[] args) {
    ...
    double areaFinal = (uOrigen == 0) ? (uDestino == 0) ? area : // m^2 a m^2
        (uDestino == 1) ? area / HECTAREA : // m^2 a Ha
            area * METROCUADRADO
        : // m^2 a pies^2

        (uOrigen == 1) ? (uDestino == 0) ? area * HECTAREA : // Ha a m^2
            (uDestino == 1) ? area : // Ha a Ha
                area * HECTAREA * METROCUADRADO
            : // Ha a pies^2
    ...
    String uOrigenStr = (uOrigen == 0) ? "metros cuadrados" : (uOrigen == 1) ? "hectáreas" : "pies cuadrados";

    String uDestinoStr = (uDestino == 0) ? "metros cuadrados" : (uDestino == 1) ? "hectáreas" : "pies cuadrados";
