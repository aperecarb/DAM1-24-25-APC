...
public class EP0133 {
        public static void main(String[] args) {
                ...
                String unidadOrigenStr = (unidadOrigen == 0) ? "B"
                                : (unidadOrigen == 1) ? "KB" : (unidadOrigen == 2) ? "MB" : "GB";
                ...
                String unidadDestinoStr = (unidadDestino == 0) ? "B"
                                : (unidadDestino == 1) ? "KB" : (unidadDestino == 2) ? "MB" : "GB";

                scanner.close();

                // Conversión de datos
                double datosFinal = (unidadOrigen == 0) ? (unidadDestino == 0) ? (datos) : // bytes a bytes
                                (unidadDestino == 1) ? (datos / KB) : // bytes a KB
                                                (unidadDestino == 2) ? (datos / MB) : // bytes a MB
                                                                (datos / GB)
                                : // bytes a GB

                                (unidadOrigen == 1) ? (unidadDestino == 0) ? (datos * KB) : // KB a bytes
                                                (unidadDestino == 1) ? (datos) : // KB a KB
                                                                (unidadDestino == 2) ? (datos / KB) : // KB a MB
                                                                                (datos / MB)
                                                : // KB a GB

                                                (unidadOrigen == 2) ? (unidadDestino == 0) ? (datos * MB) : // MB a
                                                                                                            // bytes
                                                                (unidadDestino == 1) ? (datos * KB) : // MB a KB
                                                                                (unidadDestino == 2) ? (datos) : // MB a
                                                                                                                 // MB
                                                                                                (datos / KB)
                                                                : // MB a GB

                                                                (unidadDestino == 0) ? (datos * GB) : // GB a bytes
                                                                                (unidadDestino == 1) ? (datos * MB) : // GB
                                                                                                                      // a
                                                                                                                      // KB
                                                                                                (unidadDestino == 2)
                                                                                                                ? (datos * KB)
