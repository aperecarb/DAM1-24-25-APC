...
public class EP0134_ConversionEnergia {
        public static void main(String[] args) {
                ...
                double energiaFinal = (uOrigen == 0) ? (uDestino == 0) ? (energia) : // julios a julios
                                (uDestino == 1) ? (energia / CALORIAS) : // julios a calorías
                                                (energia / KWH)
                                : // julios a kWh

                                (uOrigen == 1) ? (uDestino == 0) ? (energia * CALORIAS) : // calorías a julios
                                                (uDestino == 1) ? (energia) : // calorías a calorías
                                                                (energia * CALORIAS / KWH)
                                                : // calorías a kWh

                                                (uDestino == 0) ? (energia * KWH) : // kWh a julios
                                                                (uDestino == 1) ? (energia * KWH / CALORIAS) : // kWh a
                                                                                                               // calorías
                                                                                (energia); // kWh a kWh

                // Cambiar la unidad en el print
                String uOrigenStr = (uOrigen == 0) ? "julios" : (uOrigen == 1) ? "calorías" : "kWh";

                String uDestinoStr = (uDestino == 0) ? "julios" : (uDestino == 1) ? "calorías" : "kWh";
