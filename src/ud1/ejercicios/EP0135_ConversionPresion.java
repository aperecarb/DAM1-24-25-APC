...
public class EP0135_ConversionPresion {
        public static void main(String[] args) {
                ...
                double presionFinal = (uOrigen == 0) ? (uDestino == 0) ? (presion) : // pascales a pascales
                                (uDestino == 1) ? (presion / PA) : // pascales a atmósferas
                                                (presion / PA * MMHG)
                                : // pascales a milímetros de mercurio

                                (uOrigen == 1) ? (uDestino == 0) ? (presion * PA) : // atmósferas a pascales
                                                (uDestino == 1) ? (presion) : // atmósferas a atmósferas
                                                                (presion * MMHG)
                                                : // atmósferas a milímetros de mercurio

                                                (uDestino == 0) ? (presion / MMHG) : // mmHg a atmósferas
                                                                (uDestino == 1) ? (presion / MMHG * PA) : // mmHg a
                                                                                                          // pascales
                                                                                (presion); // mmHg a mmHg

                // Cambiar la unidad en el print
                String uOrigenStr = (uOrigen == 0) ? "pascales"
                                : (uOrigen == 1) ? "atmósferas" : "milímetros de mercurio";

                String uDestinoStr = (uDestino == 0) ? "pascales"
                                : (uDestino == 1) ? "atmósferas" : "milímetros de mercurio";
