...
public class EOE09 {
    public static void main(String[] args) {
        ...
        // 23. Una variable entera M contiene un número de mes codificado de 1 (enero) a
        // 12 (diciembre). Comprobar si corresponde a un mes de 30 días.
        int mes = 11;
        boolean v23 = mes == 4 || mes == 6 || mes == 9 || mes == 11;
        System.out.println("23: (" + mes + ") " + v23);

        // 28. Con DN, MN, AN día, mes y año de nacimiento de una persona y DA, MA, AA
