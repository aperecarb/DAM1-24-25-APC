...
public class NumerosOrdenados {
    public static void main(String[] args) {
        ...
        String ordenados = (numero1 > numero2 && numero2 > numero3) ? // No se pueden encadenar comparaciones, es
                                                                      // necesario el &&
                "Ordenados de mayor a menor"
                : (numero1 < numero2 && numero2 < numero3) ? "Ordenados de menor a mayor" : "Números desordenados";
