...
public class CalcularEdad {
  public static void main(String[] args) {
     ...
     * 
     * int edad = (mm < mesActual) ? (añoActual - aaaa) : // Si el mes de nacimiento
     * es menor
     * (mm > mesActual) ? (añoActual - aaaa - 1) : // Si el mes de nacimiento es
     * mayor
     * (dd > diaActual) ? (añoActual - aaaa - 1) : // Si es el mismo mes pero el día
     * es mayor
